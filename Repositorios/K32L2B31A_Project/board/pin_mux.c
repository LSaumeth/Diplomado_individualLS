...
- {pin_num: '11', pin_signal: ADC0_DP3/ADC0_SE3/PTE22/TPM2_CH0/UART2_TX/FXIO0_D6, label: 'J4[5]/DIFF_ADC1_DP', identifier: SendorDeLuz}
...
void BOARD_InitADCPins(void)
{
    ...
    PORT_SetPinMux(BOARD_INITADCPINS_SendorDeLuz_PORT, BOARD_INITADCPINS_SendorDeLuz_PIN, kPORT_PinDisabledOrAnalog);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
