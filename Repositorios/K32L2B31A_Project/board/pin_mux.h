...
/* Symbols to be used with PORT driver */
#define BOARD_INITADCPINS_SendorDeLuz_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADCPINS_SendorDeLuz_PIN 22U                   /*!<@brief PORT pin number */
#define BOARD_INITADCPINS_SendorDeLuz_PIN_MASK (1U << 22U)      /*!<@brief PORT pin mask */
                                                                /* @} */
